...
<div class="list-group">
  <a href="/admin/list/cartorio" class="list-group-item list-group-item-action">Listar cartórios</a>
  <a href="/admin/import/xml" class="list-group-item list-group-item-action">Importar XML</a>
  <a href="/admin/import/xls" class="list-group-item list-group-item-action">Importar planilha</a>
